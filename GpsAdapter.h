...
// Mod. Radioelf for DronPi

#ifndef GPS_ADAPTER_H_
#define GPS_ADAPTER_H_
...
void initializeGps() {
    ...
    US_MR_NBSTOP_1_BIT | US_MR_CHMODE_NORMAL | US_MR_USART_MODE_HW_HANDSHAKING; // HW_HANDSHAKING->CTS/RTS
